...
import { closeNotification } from "../features/page/page_slice";

export default function Notification() {
    const notification = useAppSelector(state => state.page.notification);
                            ...
                            <div className="p-4">
                                <div className="flex items-start">
                                    <div className="flex-shrink-0">
                                        <CheckCircleIcon aria-hidden="true" className={"h-6 w-6 " + classes[notification.type]} />
                                    </div>
